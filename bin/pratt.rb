...
#  end
#
#  opt.on '-w', '--when_to', Time, 'When to do something.' do |when_to|
#    opts.when_to = when_to
#  end
#  opt.on('-W', '--Week', "Time argument applies to a week. (Only for graphing)") do |week|
#    opts.week = true
#  end
#  opt.on('-D', '--Day', "Time argument applies to a day.") do |day|
#    opts.day = true
#  end
#
