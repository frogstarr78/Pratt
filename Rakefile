...
Spec::Rake::SpecTask.new(:rcov) do |spec|
  ...
  spec.rcov = true
  spec.rcov_opts = %w(--text-report --spec-only --exclude=activerecord,ruby-debug,shifty_week,sqlite3-ruby,rspec,mocha,erubis,chronic,colored,columnize,builder,activesupport,i18n,linecache,json_pure,rcov,abstract)
end
